...
! read general mesh parameters
  ...
  do volume_number=1,n_volumes
    ...
    read(mesh_file_unit,*)number_of_cells
    ...
    do cell=1,number_of_cells
      read(mesh_file_unit,*)	problem_volumes(volume_number)%cell_list(cell)%cell%i,	&
  ...
  do surface_number=1,n_surfaces
    ...
    read(mesh_file_unit,*)number_of_faces
    ...
    do face=1,number_of_faces
      read(mesh_file_unit,*)	problem_surfaces(surface_number)%face_list(face)%cell%i,	&
  ...
  do line_number=1,n_lines
    ...
    read(mesh_file_unit,*)number_of_cell_segments
    ...
    do segment=1,number_of_cell_segments
      read(mesh_file_unit,*)	problem_lines(line_number)%cell_segment_list(segment)%segment_point(1)%cell%i,	&
  ...
  read(mesh_file_unit,*)n_points
  
  ALLOCATE( problem_points(1:n_points) )

  do point_number=1,n_points

    read(mesh_file_unit,*)	problem_points(point_number)%cell%i,	&
