...
! File for results
  ...
  if (excitation_port.eq.1) then
    ...
    '# f,real(S11),imag(S11),abs(S11),20.0*log10(abs(S11)),real(S21),imag(S21),abs(S21),20.0*log10(abs(S21))'
  else if (excitation_port.eq.2) then  
    write(local_file_unit,*)	&
    '# f,real(S12),imag(S12),abs(S12),20.0*log10(abs(S12)),real(S22),imag(S22),abs(S22),20.0*log10(abs(S22))'
  end if
...
! then write the S parameters and the scattered power to files	 
    if (excitation_port.eq.1) then
      ...
      write(local_file_unit,8000)frequency,real(S11),imag(S11),abs(S11),20.0*log10(abs(S11)),	&
                                           real(S21),imag(S21),abs(S21),20.0*log10(abs(S21))
      ...
      write(local_file_unit,8000)frequency,real(S12),imag(S12),abs(S12),20.0*log10(abs(S12)),	&
                                           real(S22),imag(S22),abs(S22),20.0*log10(abs(S22))
